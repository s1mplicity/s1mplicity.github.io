# Commands  
Here's the list of s1mplicity commands. This one contains more than **110 commands** in **9 categories**!  
...
| **fortnite**     | Displays a player's Fortnite stats!                                      | fortnite [psn/xbl/pc] [person] | 1 seconds |
...
| **invite**       | Displays the links of s1mplicity!                                        | invite (copy)                  | 5 seconds |
| **minecraft**    | Displays information about the Minecraft server!                         | minecraft [ip]                 | 3 seconds |
| **partners**     | Displays s1mplicity partners                                             | partners                       | 1 seconds |
...
| **setlang**         | Change the server language!                                   | setlang [english/english]        | 3 seconds  |
...
| Name          | Description                      | Usage            | Cooldown  |
| ------------- | -------------------------------- | ---------------- | --------- |
| **geoip**     | Check the location of a host     | geo IP           | 5 seconds |
| **pagelinks** | Check all the links on a website | pagelinks DOMAIN | 5 seconds |
| **portscan**  | Check a host for a open port     | portscan IP      | 5 seconds |
